...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.stockwatcher.client.StockWatcher=");
    idx += (13 + "stockwatcher.client.StockWatcher".length);  // 
  }
  if (idx >= 0) {
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/stockwatcher.client.StockWatcher/_sourcemap.json 
//# sourceURL=stockwatcher.client.StockWatcher-0.js
